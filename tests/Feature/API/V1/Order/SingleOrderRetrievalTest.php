...
class SingleOrderRetrievalTest extends TestCase
{
    use RefreshDatabase;

    public function test_employee_can_retrieve_an_order_on_their_store(): void
    {
    ...
    public function test_store_owner_can_retrieve_an_order_on_their_store(): void
    {
        $storeOwner = User::factory()
            ->premium()
            ->create();
    ...
    public function test_guest_cannot_retrieve_an_order_on_a_store(): void
    {
        $storeOwner = User::factory()
            ->premium()
            ->create();
    ...
    public function test_employee_cannot_retrieve_an_order_on_another_store(): void
    {
    ...
    public function test_store_owner_cannot_retrieve_an_order_on_another_store(): void
    {
        $otherStoreOwner = User::factory()
            ->premium()
            ->create();
