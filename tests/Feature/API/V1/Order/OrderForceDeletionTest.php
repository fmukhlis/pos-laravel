...
class OrderForceDeletionTest extends TestCase
{
    use RefreshDatabase;

    public function test_store_owner_can_delete_an_order()
    {
    ...
    public function test_guest_cannot_delete_an_order()
    {
        $storeOwner = User::factory()
            ->premium()
            ->create();
    ...
    public function test_store_owner_cannot_delete_an_order_in_another_store()
    {
        $storeOwner = User::factory()
            ->premium()
            ->create();
