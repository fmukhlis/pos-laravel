...
class OrderRefundTest extends TestCase
{
    ...
    public function test_staff_can_refund_an_order_in_paid_status()
    {
        ...
        $response = $this->patchJson(
            '/api/v1/stores/' . $store->id . '/orders/' . $store->orders()->first()->id . '/refund',
            [
    ...
    public function test_guest_cannot_refund_an_order()
    {
        $storeOwner = User::factory()
            ->premium()
            ->create();
    ...
    public function test_staff_cannot_refund_an_order_in_another_store()
    {
        $storeOwner = User::factory()
            ->premium()
            ->create();
        ...
        $response = $this->patchJson(
            '/api/v1/stores/' . $otherStore->id . '/orders/' . $otherStore->orders()->first()->id . '/refund',
            [
                'authorizationCode' => '123456'
            ],
            ['Authorization' => 'Bearer ' . $token]
